            ...
            <div className="container doc-container">
                ...
                <main className="doc-main">
                    ...
                    <nav className="doc-breadcrumbs">
                        ...
                        <span className="current">{doc.category === 'General' ? 'General' : doc.category}</span>
                    </nav>
                        ...
                        <div className="doc-navigation">
                            {prevDoc ? (
                                <Link href={`/docs/${prevDoc.id}`} className="nav-card prev glass-card">
                                    <span style={{ fontSize: '0.8rem', opacity: 0.5 }}>Previous Page</span>
                            ...
                            {nextDoc ? (
                                <Link href={`/docs/${nextDoc.id}`} className="nav-card next glass-card">
                                    <span style={{ fontSize: '0.8rem', opacity: 0.5 }}>Next Page</span>
