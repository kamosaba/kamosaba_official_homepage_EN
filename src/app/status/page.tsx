            ...
            <div className="container" style={{ maxWidth: '800px' }}>
                ...
                <div className="glass-card" style={{ padding: '40px', textAlign: 'center' }}>
                    {status.loading ? (
                        <div style={{ padding: '40px' }}>
                            ...
                            <p style={{ marginTop: '20px', opacity: 0.6 }}>Checking status...</p>
                        </div>
                    ) : (
                        <>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px', marginBottom: '40px' }}>
                                <div className="glass" style={{ padding: '24px', borderRadius: '20px' }}>
                                    <p style={{ fontSize: '0.9rem', opacity: 0.6, marginBottom: '8px' }}>Current Players</p>
                                ...
                                <div className="glass" style={{ padding: '24px', borderRadius: '20px' }}>
                                    <p style={{ fontSize: '0.9rem', opacity: 0.6, marginBottom: '8px' }}>Version</p>
                                    <p style={{ fontSize: '1.5rem', fontWeight: 700 }}>{status.version || 'Unknown'}</p>
                                </div>
                            </div>

                            {status.online && status.players?.list && status.players.list.length > 0 && (
                                <div style={{ textAlign: 'left' }}>
                                    <h3 style={{ fontSize: '1.2rem', marginBottom: '16px', opacity: 0.8 }}>Online Members</h3>
                            ...
                            {!status.online && !status.loading && (
                                <div style={{
                                    ...
                                    <p style={{ opacity: 0.7, marginBottom: '32px', lineHeight: 1.8 }}>
                                        The server may be currently undergoing maintenance or is temporarily down.<br />
                                        Please check the official Discord for the latest operational status and recovery prospects.
                                    </p>
                                    <Link
                ...
                <div style={{ marginTop: '40px', textAlign: 'center' }}>
                    <p style={{ opacity: 0.5, fontSize: '0.9rem' }}>
                        IP Address: <code style={{ background: 'rgba(255,255,255,0.1)', padding: '4px 8px', borderRadius: '4px' }}>{serverConfig.displayAddress}</code>
                    </p>
                </div>
            </div>
        </div>
